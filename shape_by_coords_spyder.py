...
#           if 'attributes' in data['CityObjects'][theid]:
            for attribute in data['CityObjects'][theid]['attributes']:
                print (data['CityObjects'][theid]['attributes'][attribute])
...
#objects = bpy.data.objects
#a = objects['UUID_LOD2_011394-acaa1f62-ada3-4567-8f7a_1']
#
##b = objects['UUID_LOD2_011390-b5d493d1-4222-4f08-8fa2_1']ob=bpy.types.objects['UUID_LOD2_011452-5ef4a249-f667-46f1-be34_1']
#
#a["myProperty_Y"] =5.0